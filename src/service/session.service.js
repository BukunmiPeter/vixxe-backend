...
const sessions_model_1 = __importDefault(require("../models/sessions.model"));
function createSession(userId, userAgent) {
    return __awaiter(this, void 0, void 0, function* () {
        const session = yield sessions_model_1.default.create({ user: userId, userAgent });
...
function findSessions(query) {
    return __awaiter(this, void 0, void 0, function* () {
        return sessions_model_1.default.find(query).lean();
    });
}
exports.findSessions = findSessions;
function updateSession(query, update) {
    return __awaiter(this, void 0, void 0, function* () {
        return sessions_model_1.default.updateOne(query, update);
    });
}
...
function reIssueAccessToken({ refreshToken, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!decoded || !(0, lodash_1.get)(decoded, "session"))
            return false;
        const session = yield sessions_model_1.default.findById((0, lodash_1.get)(decoded, "session"));
